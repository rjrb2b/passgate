...
public class SecurityJwtToken {
	...
	private final String JWT_SECRET = "b5840bef8a0e3ed1a923f820a8611aa27ca196a8468dd9a9d499459148931d47";
	...
	public boolean jwtTokenValidate(String token) {
		try {
			Jwts.parserBuilder().setSigningKey(
					Keys.hmacShaKeyFor(JWT_SECRET.getBytes())).build().parseClaimsJws(token);
			return true;
		} catch (Exception e) {
